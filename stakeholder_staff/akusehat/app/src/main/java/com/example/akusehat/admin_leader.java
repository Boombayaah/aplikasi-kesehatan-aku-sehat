...
//        });
        ...
        if (!isLoggedIn) {
            ...
            profileButton.setOnClickListener(v -> {
                Intent intent = new Intent(admin_leader.this, login.class);
                startActivity(intent);
            });
    ...
    private void loadStaffTable() {
        String url = "http://192.168.1.8/aku_sehat/tbl_staff.php";
    ...
    private void hapusStaff(String idUser) {
        String url = "http://192.168.1.8/aku_sehat/hapus_staff.php";
